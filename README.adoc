...
La documentation technique du backend est disponible xref:sae-back/README.md[ici].

=== Documentation technique frontend

La documentation technique du frontend est disponible xref:sae-front/README.md[ici].
