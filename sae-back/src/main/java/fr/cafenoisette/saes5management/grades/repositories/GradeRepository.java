...
public class GradeRepository implements PanacheRepository<GradeEntity>  {
    ...
    /**
     * Get all grades or a grade by id, title, description, grade, coefficient or type, each parameter is optional and can be combined
     ...
     */
    public ArrayList<GradeEntity> getFilteredGrades(Long id, String title, String description, Long nGrade, Long coefficient, GradeType type) {
        // get all grades
